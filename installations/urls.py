...
urlpatterns = [
    ...
    path('bibliography/new/', views.BibliographyCreatView.as_view(), name='bibliography-insert'),
    url(r'^bibliography/new/(?P<pk>\d+)/$', views.BibliographyUpdateView.as_view(), name='bibliography-update'),
    url(r'^bibliography/delete/(?P<pk>\d+)/$', views.BibliographyDeleteView.as_view(), name='bibliography-delete'),
    path('bibliography/list/', views.BibliographyListView.as_view(), name='bibliography-list'),
    ...
    # url(r'^sourcetype/new/$', views.SourceTypeCreatView.as_view(), name='sourcetype-insert'),  # temporarily, it is commented but it can completely be removed later If it's not needed.
