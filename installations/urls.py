...
urlpatterns = [
    ...
    path('institution/list/adv/', views.InstitutionAdvancedSearchList, name='institution-advancedsearch'),
    ...
    path('installation/list/adv/', views.InstallationAdvancedSearchList, name='installation-advancedsearch'),
    ...
    path('watersystemcategories/new/', views.WaterSystemCategoriesCreatView.as_view(), name='watersystemcategories-insert'),
    path('watersystemcategories/new/<str:view>/', views.WaterSystemCategoriesCreatView.as_view(), name='watersystemcategories-insert'),
    path('watersystemcategories/new/<int:pk>', views.WaterSystemCategoriesUpdateView.as_view(), name='watersystemcategories-update'),
    url(r'^watersystemcategories/delete/(?P<pk>\d+)/$', views.WaterSystemCategoriesDeleteView.as_view(), name='watersystemcategories-delete'),
    path('watersystemcategories/list', views.WaterSystemCategoriesListView.as_view(), name='watersystemcategories-list'),
