...
urlpatterns = [
    ...
    path('institution/new/', views.edit_institution, name='institution-insert'),  # get and post req. for insert operation
    ...
    url(r'^evidence/new/$', views.edit_evidence, name='evidence-insert'),
